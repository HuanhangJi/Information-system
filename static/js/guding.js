...
function(t) {
	...
	i = function(n, s) {
		...
		var c = function() {
			...
			l.isEmptyObject(t) && r || (r = Object.assign({},
			e, r, t))
		},
		f = function() {
			return r.disable
		...
		u = {
			...
			reset: function() {
				var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
				if (t.disable = t.disable || !1, "fixed" === u.position || null === u.position || !(void 0 === t.top && void 0 === t.bottom || void 0 !== t.top && (parseInt(l.getStyle(n, "top")) || 0) === t.top || void 0 !== t.bottom && (parseInt(l.getStyle(n, "bottom")) || 0) === t.bottom)) { ! 0 === t.disable ? !0 === p.isAttached && p.detach() : !1 === p.isAttached && p.attach();
		...
		D = function() {
			R(),
			j >= h ? M() : (q(), A || (l.event.bind(t, "scroll", q), A = !0))
		},
		W = function() {
			n.style.position = "",
			n.style.left = "",
		...
		$ = function() {
			F && (l.event.unbind(t, "resize", Y), F = !1),
			M()
		},
		Q = function() {
			F || (l.event.bind(t, "resize", Y), F = !0),
			d(),
			f() ? M() : D()
		};
		this.options = function(t) {
			return t ? r.option || null: Object.assign({},
			r)
		},
		this.reinit = P,
...
function(t) {
	...
	n = function(e, i) {
		return t.getComputedStyle ? i ? o.defaultView.getComputedStyle(e, null).getPropertyValue(i) : o.defaultView.getComputedStyle(e, null) : e.currentStyle ? i ? e.currentStyle[i.replace(/-\w/g,
		function(t) {
	...
	e.Helpers = {
		...
		getCascadedStyle: function(e) {
			...
			if (Object.keys(s).length < 3) {
				s = {};
				for (var l in n) isNaN(l) || (s[n[l].replace(/-\w/g,
				function(t) {
					return t.toUpperCase().replace("-", "")
			...
			if (s.margin || "auto" !== s.marginLeft ? s.margin || s.marginLeft !== s.marginRight || s.marginLeft !== s.marginTop || s.marginLeft !== s.marginBottom || (s.margin = s.marginLeft) : s.margin = "auto", !s.margin && "0px" === s.marginLeft && "0px" === s.marginRight) {
				...
				c = a - (parseInt(s.left) || 0) - (parseInt(s.left) || 0),
				f = e.parentNode.offsetWidth - e.offsetWidth - a - (parseInt(s.left) || 0) + (parseInt(s.left) || 0) - c;
